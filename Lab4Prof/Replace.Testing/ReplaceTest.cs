    ...
    public class ReplaceTest
    {
        ...
        public void NullSequenceThrowsANE()
        {
            Assert.Throws<ArgumentNullException>(()=>
                Replace.Implementation.Replace.MacroExpansion((IEnumerable<int>) null,3,new int[1]).Count());
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                Replace.Implementation.Replace.MacroExpansion(new int[1], 3, ((IEnumerable<int>) null).ToArray()));
        }
        ...
        public void NothingToReplace()
        {
            var s = new[] {1, 2, 3};
            var nV = new[] {7, 45};
            var res = Replace.Implementation.Replace.MacroExpansion(s, 467, nV);
        ...
        public void Replace1By1Once()
        {
            ...
            var nV = new[] { 7 };
            var res = Replace.Implementation.Replace.MacroExpansion(s, 2, nV);
        ...
        public void Replace1By1Thrice()
        {
            ...
            var nV = new[] { 70 };
            var res = Replace.Implementation.Replace.MacroExpansion(s, 1, nV);
            Assert.That(res, Is.EqualTo(expected));
        }
        ...
        public void Replace1By1OnceOnObjects()
        {
            ...
            var res = Replace.Implementation.Replace.MacroExpansion(s, new C(1,"s"), nV);
            Assert.That(res, Is.EqualTo(expected));
        }
